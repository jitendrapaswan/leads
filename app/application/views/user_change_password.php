			...
			<div class="panel panel-default" style="margin-top:20px;">
				<div class="panel-heading">
			  	...
			  	<div class="panel-body">
			  		<form class="form-horizontal" role="form" action="<?php echo base_url(); ?>user/change_password" method="post" name="userchangepwd" id="userchangepwd">			  			
...
$(document).ready(function(){	
    ...
    rules: 
    {
	    oldpassword: {
	        ...
	        remote : 
	        {
	            url: "<?php echo base_url();?>user/check_old_password",
	            type: 'POST'                                      
	        }
	    },
	    newpassword: {
